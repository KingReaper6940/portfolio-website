      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 pt-4 md:pt-12">
          ...
          <p className="text-gray-600 text-base md:text-lg max-w-2xl mx-auto pb-8">
            Feedback from colleagues, collaborators, and users who have experienced 
            my work in AI development, product building, and entrepreneurship.
          </p>
        </div>
            ...
            <div className="bg-white border-4 border-black rounded-3xl py-8 md:py-14 px-6 md:px-8 md:pr-72 lg:pr-72">
              ...
              <div className="md:max-w-[65%]">
                <p className="text-sm md:text-base lg:text-lg mb-6 leading-relaxed">
                  Vrishn's Cursor Prompt Enhancer has significantly improved my development workflow. 
                  The AI-powered suggestions are incredibly accurate, and the voice-to-text feature 
                  is a game-changer for hands-free coding. Highly recommended for any developer!
                </p>

                <div>
                  <div className="font-bold text-base md:text-lg">Extension User</div>
                  <div className="text-gray-600 text-sm md:text-base">VS Code Marketplace Review</div>
                </div>
              </div>
            </div>
